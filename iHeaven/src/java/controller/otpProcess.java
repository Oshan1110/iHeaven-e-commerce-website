 ...
 * @author ADHIII
 */
@WebServlet(name = "otpProcess", urlPatterns = {"/otpProcess"})
public class otpProcess extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ses.getAttribute("email") == null) {
            ...
            String verifyCode = Code.get("otpCode").getAsString();
            ...
            c.add(Restrictions.eq("otp", verifyCode));
            ...
            if (!c.list().isEmpty()) {
                ...
                responseObject.addProperty("message", "Invalid OTP Code.");
            }
